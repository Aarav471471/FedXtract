...
async function createCase(){
  ...
  const res = await fetch("http://127.0.0.1:8000/create_case", {
    method:"POST",
    headers:{ "Content-Type":"application/json" },
...
async function loadDCAs(){
  const res = await fetch("http://127.0.0.1:8000/dcas");
  const data = await res.json();
...
async function assignCase(){
  let res = await fetch("http://127.0.0.1:8000/assign_case",{
    method:"POST"
  });
...
async function recoverCase(){
  ...
  let res = await fetch("http://127.0.0.1:8000/recover_case",{
    method:"POST",
    headers:{ "Content-Type":"application/json" },
...
async function autopayCase(){
  ...
  let res = await fetch("http://127.0.0.1:8000/autopay",{
    method:"POST",
    headers:{ "Content-Type":"application/json" },
...
async function loadLeaderboard(){
  let res = await fetch("http://127.0.0.1:8000/leaderboard");
  let data = await res.json();
...
async function loadDashboard(){
  let res = await fetch("http://127.0.0.1:8000/dashboard_stats");
